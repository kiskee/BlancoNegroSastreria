...
export default function HeroWomen() {
  return (
    <section className="relative w-full h-[90vh] flex items-center justify-center overflow-hidden border-b">
      ...
      {/* Gradient bottom (opcional, no afecta la imagen principal) */}
